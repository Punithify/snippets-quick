...
export default function SnippetForm({ snippet }) {
  ...
  return (
    <form onSubmit={handleSubmit(snippet ? updateSnippet : createSnippet)}>
      {errors.name || errors.code || errors.description || errors.language ? (
        <div
          class="bg-orange-100 my-4 border-l-4 border-orange-500 text-orange-700 p-4"
          role="alert"
        >
      ...
      <button
        className="ml-2 bg-red-800 hover:bg-red-900 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline mr-2"
